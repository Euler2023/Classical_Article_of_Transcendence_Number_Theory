...
\begin{tikzpicture}[overlay,remember picture,font=\sffamily\bfseries]
	...
	text align = center
	},decorate] ([xshift=-2mm]current page.north) arc(150:245:11);
%
\begin{scope}
...
([xshift=-10.55cm,yshift=-2cm]current page.center) {TRANSCENDENTAL NUMBERS};
\node[text=white,anchor=west,scale=2,inner sep=0pt] at
([xshift=-10.55cm,yshift=-4cm]current page.center) {Carl Ludwig Siegel};
\node[text=white!70!gray,anchor=west,scale=0.8,inner sep=0pt] at
([xshift=-10.5cm,yshift=-5.8cm]current page.center) {Copyright \textcopyright\ 1949 by Carl Ludwig Siegel \& Princeton University Press. All rights reserved.};
\node[text=white,anchor=west,scale=2,inner sep=0pt] at
([xshift=-10.5cm,yshift=-7cm]current page.center) {PRINCETON UNIVERSITY PRESS 1949};
\end{tikzpicture}
