%# -*- coding: utf-8-unix -*-
\chapter*{FURTHER PUBLICATIONS}
\addcontentsline{toc}{chapter}{Further Publications}
\markboth{FURTHER PUBLICATIONS}{FURTHER PUBLICATIONS}

% hanglist environment is defined globally in trans_number_baker.tex

We give below a selected list of the new works on transcendental number\index{transcendental number} theory that have appeared since the first printing; the list contains also a few older papers that were omitted originally. Abbreviations and other conventions have been adopted as before (see page 130).
